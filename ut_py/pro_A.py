...
def dia_example():  # 국내 각 지역별 예시 사투리 문장
    ...
    ex_list.insert(END, '\n<강원>\n\n\t마날장아찌랑 맛소굼 가져와\n\n\t저 게그른 눔 거칫하문 그짓말이야\n\n\n<경기>\n\n\t우째 방뎅이를 그리 흔드냐\n\n'
                        ...
                        '\t저기 정지에서 감자찌짐이랑 덴장국 꾸렁내가 나더라\n\n\n<경북>\n\n\t아니 복송아 색까리 왜 이래?!\n\n'
                        '\t바댁에 멀까락이랑 속눈섶이 자꾸만 떨어지네.\n\n\n<전남>\n\n\t가는비가 뜬걸로 오네?\n\n'
                        '\t마댕에서 띤죽 먹자.\n\n\n<전북>\n\n\t냇갈에 가달썩이 많네!\n\n\t퇴깽이가 숨풀에 숨어있어\n\n\n'
                        '<충남>\n\n\t얘! 봄판 하지감자가 맛있단다!\n\n\t진당 이르내야?\n\n\n'
                        '<충북>\n\n\t그거 워요일 새벅에 새닥이 가주온 청북장이에요.\n\n'
                        '\t올개 에사춘 겔혼식은 나랑 어마이만 가려고 한다.\n\n\n'
                        '<제주>\n\n\t얼저뭇에 그 아주방네 집에 한갑잔체가 있었어.\n\n'
                        '\t아히가 강생이랑 잘도 재게 뛰어다니다가 가싸 가찌 베개동산으로 가버렸다.\n')
